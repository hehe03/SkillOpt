...
DEFAULT_ORIGINAL_SKILL = DEFAULT_WORKSPACE_ROOT / "source-skill" / "SKILL.md"
DEFAULT_RULES = DEFAULT_WORKSPACE_ROOT / "source-skill" / "references" / "rules.md"
DEFAULT_OUTPUT = DEFAULT_WORKSPACE_ROOT / "init-skill" / "initial_skill.md"
